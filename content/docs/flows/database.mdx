...
📁 lib/db.ts               - Kysely client configuration
📁 lib/db.types.ts         - Database type definitions for Kysely
📁 repositories/           - Data access layer (Kysely + raw SQL)
📁 services/               - Business logic built on repositories
📁 actions/                - Server actions orchestrating database operations
```
