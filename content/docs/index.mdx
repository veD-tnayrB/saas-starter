...
Built on the [Taxonomy](https://github.com/shadcn-ui/taxonomy) app by shadcn, it integrates Next.js 16, Prisma, Neon, Auth.js v5, Resend, React Email, Shadcn/ui, and Stripe.
