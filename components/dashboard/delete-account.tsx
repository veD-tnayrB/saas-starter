...
export function DeleteAccountSection() {
  ...
  return (
    <>
      ...
      >
        <div className="flex flex-col gap-4 rounded-xl border border-destructive/50 p-4">
          <div className="flex flex-col gap-2">
            <div className="flex items-center gap-2">
              <span className="text-[15px] font-medium">Are you sure ?</span>

              {userPaidPlan ? (
                <div className="flex items-center gap-1 rounded-md bg-destructive/10 p-1 pr-2 text-xs font-medium text-destructive">
                  <div className="m-0.5 rounded-full bg-destructive p-[3px]">
                    <Icons.close
                      size={10}
